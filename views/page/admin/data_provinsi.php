<?php
include 'app/controller/admin/post_provinsi.php';
?>
            ...
            <?php
                ...
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title mt-1">Daftar Provinsi</h3>
                        <div class="float-right">
                            <button type="button" class="btn btn-sm btn-primary" data-toggle="modal" data-target="#modal-default"><i class="fas fa-plus-circle"></i> Create Provinsi</button>
                        </div>
                    </div>
                    <div class="card-body">
